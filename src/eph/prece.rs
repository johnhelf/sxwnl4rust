use crate::eph::eph_base::{rad2mrad, llr_conv, RAD};
...
impl Prece {
    ...
    const PRECE_TAB_IAU2000: [(f64, f64, f64, f64, f64, f64); 12] = [
        ...
        (0.0,    2004.191748, -0.426935, -0.041825, -0.0000601, -0.0000001), // th
        (2.5976176, 2306.080951, 0.301902, 0.017966, -0.0000327, -0.0000002), // Z
        (-2.5976176, 2306.080323, 1.094779, 0.018227, 0.0000470, -0.0000003)  // z
    ];

    /// P03岁差表
    const PRECE_TAB_P03: [(f64, f64, f64, f64, f64, f64); 12] = [
        (0.0, 5038.481507, -1.0790069, -0.00114045, 0.000132851, -9.51e-8),  // fi
        ...
        (0.0, 10.556403, -2.3814292, -0.00121197, 0.000170663, -5.60e-8),  // x
        (0.0, 46.998973, -0.0334926, -0.00012559, 1.13e-7, -2.2e-9),  // pi
        (629546.7936, -867.95758, 0.157992, -0.0005371, -0.00004797, 7.2e-8),  // II
        (0.0, 5028.796195, 1.1054348, 0.00007964, -0.000023857, 3.83e-8),  // p
        (0.0, 2004.191903, -0.4294934, -0.04182264, -7.089e-6, -1.274e-7),  // th
    ...
    pub fn hcjj(t: f64) -> f64 {
        ...
        (84381.4060 - 46.836769 * t - 0.0001831 * t2 + 
        0.00200340 * t3 - 5.76e-7 * t4 - 4.34e-8 * t5) / RAD
    }
